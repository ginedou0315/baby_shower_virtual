...
function WelcomeSection() {
  ...
  useEffect(() => {
    const targetDate = new Date("2025-07-13T16:00:00");
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-8 md:p-12 fade-in">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              We're so excited to share this special moment with you! Join us
              virtually as we celebrate the upcoming arrival of our precious
              baby girl. Your love and support mean the world to us! 💖
            </p>
